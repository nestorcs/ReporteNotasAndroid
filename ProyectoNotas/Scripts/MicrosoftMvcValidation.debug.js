...
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.ValidationContext3

Sys.Mvc.$create_ValidationContext3 = function Sys_Mvc_ValidationContext3() { return {}; }
...
Sys.Mvc.NumberValidator.prototype = {
    ...
    validate: function Sys_Mvc_NumberValidator$validate(value, Context3) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="Context3" type="Sys.Mvc.ValidationContext3">
        /// </param>
...
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.FormContext3

Sys.Mvc.FormContext3 = function Sys_Mvc_FormContext3(formElement, validationSummaryElement) {
    ...
    /// </field>
    /// <field name="fields" type="Array" elementType="FieldContext3">
    /// </field>
    ...
    formElement[Sys.Mvc.FormContext3._formValidationTag] = this;
...
Sys.Mvc.FormContext3._Application_Load = function Sys_Mvc_FormContext3$_Application_Load() {
    var allFormOptions = window.mvcClientValidationMetadata;
    if (allFormOptions) {
        while (allFormOptions.length > 0) {
            var thisFormOptions = allFormOptions.pop();
            Sys.Mvc.FormContext3._parseJsonOptions(thisFormOptions);
        }
    }
}
Sys.Mvc.FormContext3._getFormElementsWithName = function Sys_Mvc_FormContext3$_getFormElementsWithName(formElement, name) {
    /// <param name="formElement" type="Object" domElement="true">
    /// </param>
    ...
    for (var i = 0; i < allElementsWithName.length; i++) {
        ...
        if (Sys.Mvc.FormContext3._isElementInHierarchy(formElement, thisElement)) {
            Array.add(allElementsWithNameInForm, thisElement);
        }
    }
    return allElementsWithNameInForm;
}
Sys.Mvc.FormContext3.getValidationForForm = function Sys_Mvc_FormContext3$getValidationForForm(formElement) {
    /// <param name="formElement" type="Object" domElement="true">
    /// </param>
    /// <returns type="Sys.Mvc.FormContext3"></returns>
    return formElement[Sys.Mvc.FormContext3._formValidationTag];
}
Sys.Mvc.FormContext3._isElementInHierarchy = function Sys_Mvc_FormContext3$_isElementInHierarchy(parent, child) {
...
Sys.Mvc.FormContext3._parseJsonOptions = function Sys_Mvc_FormContext3$_parseJsonOptions(options) {
    ...
    var formContext3 = new Sys.Mvc.FormContext3(formElement, validationSummaryElement);
    formContext3.enableDynamicValidation();
    formContext3.replaceValidationSummary = options.ReplaceValidationSummary;
    for (var i = 0; i < options.Fields.length; i++) {
        var field = options.Fields[i];
        var fieldElements = Sys.Mvc.FormContext3._getFormElementsWithName(formElement, field.FieldName);
        ...
        var fieldContext3 = new Sys.Mvc.FieldContext3(formContext3);
        Array.addRange(fieldContext3.elements, fieldElements);
        fieldContext3.validationMessageElement = validationMessageElement;
        fieldContext3.replaceValidationMessageContents = field.ReplaceValidationMessageContents;
        for (var j = 0; j < field.ValidationRules.length; j++) {
            ...
            if (validator) {
                ...
                Array.add(fieldContext3.validations, validation);
            }
        }
        fieldContext3.enableDynamicValidation();
        Array.add(formContext3.fields, fieldContext3);
    }
    ...
    registeredValidatorCallbacks.push(Function.createDelegate(null, function() {
        return Sys.Mvc._validationUtil.arrayIsNullOrEmpty(formContext3.validate('submit'));
    }));
    return formContext3;
}
Sys.Mvc.FormContext3.prototype = {
    ...
    addError: function Sys_Mvc_FormContext3$addError(message) {
        /// <param name="message" type="String">
        /// </param>
        this.addErrors([ message ]);
    },
    
    addErrors: function Sys_Mvc_FormContext3$addErrors(messages) {
    ...
    clearErrors: function Sys_Mvc_FormContext3$clearErrors() {
        Array.clear(this._errors);
        this._onErrorCountChanged();
    },
    
    _displayError: function Sys_Mvc_FormContext3$_displayError() {
        if (this._validationSummaryElement) {
            ...
            Sys.UI.DomElement.removeCssClass(this._validationSummaryElement, Sys.Mvc.FormContext3._validationSummaryValidCss);
            Sys.UI.DomElement.addCssClass(this._validationSummaryElement, Sys.Mvc.FormContext3._validationSummaryErrorCss);
        }
    },
    
    _displaySuccess: function Sys_Mvc_FormContext3$_displaySuccess() {
        ...
        if (validationSummaryElement) {
            ...
            Sys.UI.DomElement.removeCssClass(validationSummaryElement, Sys.Mvc.FormContext3._validationSummaryErrorCss);
            Sys.UI.DomElement.addCssClass(validationSummaryElement, Sys.Mvc.FormContext3._validationSummaryValidCss);
        }
    },
    
    enableDynamicValidation: function Sys_Mvc_FormContext3$enableDynamicValidation() {
    ...
    _findSubmitButton: function Sys_Mvc_FormContext3$_findSubmitButton(element) {
    ...
    _form_OnClick: function Sys_Mvc_FormContext3$_form_OnClick(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
        this._submitButtonClicked = this._findSubmitButton(e.target);
    },
    
    _form_OnSubmit: function Sys_Mvc_FormContext3$_form_OnSubmit(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
        var form = e.target;
    ...
    _onErrorCountChanged: function Sys_Mvc_FormContext3$_onErrorCountChanged() {
    ...
    validate: function Sys_Mvc_FormContext3$validate(eventName) {
...
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.FieldContext3

Sys.Mvc.FieldContext3 = function Sys_Mvc_FieldContext3(formContext3) {
    /// <param name="formContext3" type="Sys.Mvc.FormContext3">
    /// </param>
    ...
    /// </field>
    /// <field name="formContext3" type="Sys.Mvc.FormContext3">
    /// </field>
    ...
    this.formContext3 = formContext3;
...
Sys.Mvc.FieldContext3.prototype = {
    _onBlurHandler: null,
    ...
    addError: function Sys_Mvc_FieldContext3$addError(message) {
        /// <param name="message" type="String">
        /// </param>
        this.addErrors([ message ]);
    },
    
    addErrors: function Sys_Mvc_FieldContext3$addErrors(messages) {
        /// <param name="messages" type="Array" elementType="String">
        /// </param>
        if (!Sys.Mvc._validationUtil.arrayIsNullOrEmpty(messages)) {
            Array.addRange(this._errors, messages);
    ...
    clearErrors: function Sys_Mvc_FieldContext3$clearErrors() {
        Array.clear(this._errors);
        this._onErrorCountChanged();
    },
    
    _displayError: function Sys_Mvc_FieldContext3$_displayError() {
        ...
        if (validationMessageElement) {
            ...
            Sys.UI.DomElement.removeCssClass(validationMessageElement, Sys.Mvc.FieldContext3._validationMessageValidCss);
            Sys.UI.DomElement.addCssClass(validationMessageElement, Sys.Mvc.FieldContext3._validationMessageErrorCss);
        }
        var elements = this.elements;
        for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
            Sys.UI.DomElement.removeCssClass(element, Sys.Mvc.FieldContext3._inputElementValidCss);
            Sys.UI.DomElement.addCssClass(element, Sys.Mvc.FieldContext3._inputElementErrorCss);
        }
    },
    
    _displaySuccess: function Sys_Mvc_FieldContext3$_displaySuccess() {
        var validationMessageElement = this.validationMessageElement;
        if (validationMessageElement) {
            if (this.replaceValidationMessageContents) {
                Sys.Mvc._validationUtil.setInnerText(validationMessageElement, '');
            }
            Sys.UI.DomElement.removeCssClass(validationMessageElement, Sys.Mvc.FieldContext3._validationMessageErrorCss);
            Sys.UI.DomElement.addCssClass(validationMessageElement, Sys.Mvc.FieldContext3._validationMessageValidCss);
        }
        var elements = this.elements;
        for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
            Sys.UI.DomElement.removeCssClass(element, Sys.Mvc.FieldContext3._inputElementErrorCss);
            Sys.UI.DomElement.addCssClass(element, Sys.Mvc.FieldContext3._inputElementValidCss);
        }
    },
    
    _element_OnBlur: function Sys_Mvc_FieldContext3$_element_OnBlur(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
        if (e.target[Sys.Mvc.FieldContext3._hasTextChangedTag] || e.target[Sys.Mvc.FieldContext3._hasValidationFiredTag]) {
            this.validate('blur');
        }
    },
    
    _element_OnChange: function Sys_Mvc_FieldContext3$_element_OnChange(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
        e.target[Sys.Mvc.FieldContext3._hasTextChangedTag] = true;
    },
    
    _element_OnInput: function Sys_Mvc_FieldContext3$_element_OnInput(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
        e.target[Sys.Mvc.FieldContext3._hasTextChangedTag] = true;
        if (e.target[Sys.Mvc.FieldContext3._hasValidationFiredTag]) {
            this.validate('input');
        }
    },
    
    _element_OnPropertyChange: function Sys_Mvc_FieldContext3$_element_OnPropertyChange(e) {
        /// <param name="e" type="Sys.UI.DomEvent">
        /// </param>
    ...
    enableDynamicValidation: function Sys_Mvc_FieldContext3$enableDynamicValidation() {
        var elements = this.elements;
        for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
    ...
    _getErrorString: function Sys_Mvc_FieldContext3$_getErrorString(validatorReturnValue, fieldErrorMessage) {
    ...
    _getStringValue: function Sys_Mvc_FieldContext3$_getStringValue() {
        /// <returns type="String"></returns>
        var elements = this.elements;
        return (elements.length > 0) ? elements[0].value : null;
    },
    
    _markValidationFired: function Sys_Mvc_FieldContext3$_markValidationFired() {
        var elements = this.elements;
        for (var i = 0; i < elements.length; i++) {
            var element = elements[i];
            element[Sys.Mvc.FieldContext3._hasValidationFiredTag] = true;
        }
    },
    
    _onErrorCountChanged: function Sys_Mvc_FieldContext3$_onErrorCountChanged() {
        if (!this._errors.length) {
            this._displaySuccess();
        }
        else {
    ...
    validate: function Sys_Mvc_FieldContext3$validate(eventName) {
        /// <param name="eventName" type="String">
        /// </param>
        /// <returns type="Array" elementType="String"></returns>
        ...
        for (var i = 0; i < validations.length; i++) {
            ...
            var Context3 = Sys.Mvc.$create_ValidationContext3();
            Context3.eventName = eventName;
            Context3.fieldContext3 = this;
            Context3.validation = validation;
            var retVal = validation.validator(value, Context3);
...
Sys.Mvc.RangeValidator.prototype = {
    ...
    validate: function Sys_Mvc_RangeValidator$validate(value, Context3) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="Context3" type="Sys.Mvc.ValidationContext3">
        /// </param>
...
Sys.Mvc.RegularExpressionValidator.prototype = {
    ...
    validate: function Sys_Mvc_RegularExpressionValidator$validate(value, Context3) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="Context3" type="Sys.Mvc.ValidationContext3">
        /// </param>
...
Sys.Mvc.RequiredValidator.prototype = {
    ...
    validate: function Sys_Mvc_RequiredValidator$validate(value, Context3) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="Context3" type="Sys.Mvc.ValidationContext3">
        /// </param>
        /// <returns type="Object"></returns>
        var elements = Context3.fieldContext3.elements;
        if (!elements.length) {
            return true;
        }
...
Sys.Mvc.StringLengthValidator.prototype = {
    ...
    validate: function Sys_Mvc_StringLengthValidator$validate(value, Context3) {
        /// <param name="value" type="String">
        /// </param>
        /// <param name="Context3" type="Sys.Mvc.ValidationContext3">
        /// </param>
...
Sys.Mvc.FormContext3.registerClass('Sys.Mvc.FormContext3');
Sys.Mvc.FieldContext3.registerClass('Sys.Mvc.FieldContext3');
...
Sys.Mvc.FormContext3._validationSummaryErrorCss = 'validation-summary-errors';
Sys.Mvc.FormContext3._validationSummaryValidCss = 'validation-summary-valid';
Sys.Mvc.FormContext3._formValidationTag = '__MVC_FormValidation';
Sys.Mvc.FieldContext3._hasTextChangedTag = '__MVC_HasTextChanged';
Sys.Mvc.FieldContext3._hasValidationFiredTag = '__MVC_HasValidationFired';
Sys.Mvc.FieldContext3._inputElementErrorCss = 'input-validation-error';
Sys.Mvc.FieldContext3._inputElementValidCss = 'input-validation-valid';
Sys.Mvc.FieldContext3._validationMessageErrorCss = 'field-validation-error';
Sys.Mvc.FieldContext3._validationMessageValidCss = 'field-validation-valid';
...
Sys.Application.add_load(function() {
  ...
  Sys.Mvc.FormContext3._Application_Load();
});
