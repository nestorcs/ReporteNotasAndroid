...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			this.errorContext3 = this.labelContainer.length && this.labelContainer || $(this.currentForm);
		...
		errors: function() {
			return $( this.settings.errorElement + "." + this.settings.errorClass, this.errorContext3 );
		},
