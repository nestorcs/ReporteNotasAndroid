...
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.AjaxContext3

Sys.Mvc.AjaxContext3 = function Sys_Mvc_AjaxContext3(request, updateTarget, loadingElement, insertionMode) {
...
Sys.Mvc.AjaxContext3.prototype = {
    _insertionMode: 0,
    ...
    get_data: function Sys_Mvc_AjaxContext3$get_data() {
    ...
    get_insertionMode: function Sys_Mvc_AjaxContext3$get_insertionMode() {
        /// <value type="Sys.Mvc.InsertionMode"></value>
        return this._insertionMode;
    },
    
    get_loadingElement: function Sys_Mvc_AjaxContext3$get_loadingElement() {
        /// <value type="Object" domElement="true"></value>
        return this._loadingElement;
    },
    
    get_object: function Sys_Mvc_AjaxContext3$get_object() {
        /// <value type="Object"></value>
        var executor = this.get_response();
        return (executor) ? executor.get_object() : null;
    },
    
    get_response: function Sys_Mvc_AjaxContext3$get_response() {
        /// <value type="Sys.Net.WebRequestExecutor"></value>
        return this._response;
    },
    set_response: function Sys_Mvc_AjaxContext3$set_response(value) {
        /// <value type="Sys.Net.WebRequestExecutor"></value>
        this._response = value;
        return value;
    },
    
    get_request: function Sys_Mvc_AjaxContext3$get_request() {
        /// <value type="Sys.Net.WebRequest"></value>
        return this._request;
    },
    
    get_updateTarget: function Sys_Mvc_AjaxContext3$get_updateTarget() {
        /// <value type="Object" domElement="true"></value>
...
Sys.Mvc.MvcHelpers._asyncRequest = function Sys_Mvc_MvcHelpers$_asyncRequest(url, verb, body, triggerElement, ajaxOptions) {
    ...
    var ajaxContext3 = new Sys.Mvc.AjaxContext3(request, updateElement, loadingElement, ajaxOptions.insertionMode);
    var continueRequest = true;
    if (ajaxOptions.onBegin) {
        continueRequest = ajaxOptions.onBegin(ajaxContext3) !== false;
    }
    if (loadingElement) {
        Sys.UI.DomElement.setVisible(ajaxContext3.get_loadingElement(), true);
    }
    if (continueRequest) {
        request.add_completed(Function.createDelegate(null, function(executor) {
            Sys.Mvc.MvcHelpers._onComplete(request, ajaxOptions, ajaxContext3);
        }));
        request.invoke();
    }
}
Sys.Mvc.MvcHelpers._onComplete = function Sys_Mvc_MvcHelpers$_onComplete(request, ajaxOptions, ajaxContext3) {
    /// <param name="request" type="Sys.Net.WebRequest">
    /// </param>
    /// <param name="ajaxOptions" type="Sys.Mvc.AjaxOptions">
    /// </param>
    /// <param name="ajaxContext3" type="Sys.Mvc.AjaxContext3">
    /// </param>
    ajaxContext3.set_response(request.get_executor());
    if (ajaxOptions.onComplete && ajaxOptions.onComplete(ajaxContext3) === false) {
        return;
    }
    var statusCode = ajaxContext3.get_response().get_statusCode();
    if ((statusCode >= 200 && statusCode < 300) || statusCode === 304 || statusCode === 1223) {
        if (statusCode !== 204 && statusCode !== 304 && statusCode !== 1223) {
            var contentType = ajaxContext3.get_response().getResponseHeader('Content-Type');
            if ((contentType) && (contentType.indexOf('application/x-javascript') !== -1)) {
                eval(ajaxContext3.get_data());
            }
            else {
                Sys.Mvc.MvcHelpers.updateDomElement(ajaxContext3.get_updateTarget(), ajaxContext3.get_insertionMode(), ajaxContext3.get_data());
            }
        }
        if (ajaxOptions.onSuccess) {
            ajaxOptions.onSuccess(ajaxContext3);
        }
    }
    else {
        if (ajaxOptions.onFailure) {
            ajaxOptions.onFailure(ajaxContext3);
        }
    }
    if (ajaxContext3.get_loadingElement()) {
        Sys.UI.DomElement.setVisible(ajaxContext3.get_loadingElement(), false);
    }
}
...
Sys.Mvc.AjaxContext3.registerClass('Sys.Mvc.AjaxContext3');
